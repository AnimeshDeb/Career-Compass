...
const CompaniesAuthContext=React.createContext()
export function useAuth(){
    return useContext (CompaniesAuthContext)
...
export function CompaniesAuthProvider({children}){
   ...
   // in the other pages/ files.
    ...
    return(
        <CompaniesAuthContext.Provider value={value}>
            {!loading&&children}
        </CompaniesAuthContext.Provider>
    )
    }
