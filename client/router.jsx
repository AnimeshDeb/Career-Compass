...
export const router = createBrowserRouter([
  ...
  {
    path:"/AdminUpdateProfile", element: ( <AuthProvider><AdminPrivateRoute><AdminUpdateProfile/></AdminPrivateRoute></AuthProvider>)
  },
  {
    path: "/ForgotPassword", element: (<AuthProvider><ForgotPassword/></AuthProvider>)
  },
  {
    path: "/CompaniesLogin", element: (<CompaniesAuthProvider><CompaniesLogin/></CompaniesAuthProvider>)
  },
  {
    path: "/CompaniesSignup", element: (<CompaniesAuthProvider><CompaniesSignup/></CompaniesAuthProvider>)
  },
  {
    path: "/CompaniesUser", element: (<CompaniesAuthProvider><CompaniesPrivateRoute><CompaniesUser/></CompaniesPrivateRoute></CompaniesAuthProvider>)
  },
  {
    path: "/CompaniesPrivateRoute", element: (<CompaniesAuthProvider><CompaniesPrivateRoute/></CompaniesAuthProvider>)
  },
  {
    path: "/CompaniesUpdateProfile", element: (<CompaniesAuthProvider> <CompaniesPrivateRoute><CompaniesUpdateProfile/></CompaniesPrivateRoute></CompaniesAuthProvider>)
  },
  {
    path: "/CompaniesForgotPassword", element: (<CompaniesAuthProvider><CompaniesUpdateProfile/></CompaniesAuthProvider>)
  },
  {
    path: "/SeekerLogin", element: (<SeekerAuthProvider><SeekerLogin/></SeekerAuthProvider>)
  },
  {
    path: "/SeekerSignup", element: (<SeekerAuthProvider><SeekerSignup/></SeekerAuthProvider>)
  },
  {
    path: "/SeekerUser", element: (<SeekerAuthProvider><SeekerPrivateRoute><SeekerUser/></SeekerPrivateRoute></SeekerAuthProvider>)
  },
  {
    path: "/SeekerPrivateRoute", element: (<SeekerAuthProvider><CompaniesPrivateRoute/></SeekerAuthProvider>)
  },
  {
    path: "/SeekerUpdateProfile", element: (<SeekerAuthProvider> <SeekerPrivateRoute><SeekerUpdateProfile/></SeekerPrivateRoute></SeekerAuthProvider>)
  },
  {
    path: "/SeekerForgotPassword", element: (<SeekerAuthProvider><SeekerUpdateProfile/></SeekerAuthProvider>)
  },
